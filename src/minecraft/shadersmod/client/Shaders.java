                ...
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        if (shaderline != null)
                        {
                            ...
                            else if (!shaderline.isConstInt("shadowMapResolution") && !shaderline.isComment("SHADOWRES"))
                            {
                                if (!shaderline.isConstFloat("shadowMapFov") && !shaderline.isComment("SHADOWFOV"))
                                {
                                    if (!shaderline.isConstFloat("shadowDistance") && !shaderline.isComment("SHADOWHPL"))
                                    {
                                        ...
                                        else if (!shaderline.isConstFloat("wetnessHalflife") && !shaderline.isComment("WETNESSHL"))
                                        {
                                            if (!shaderline.isConstFloat("drynessHalflife") && !shaderline.isComment("DRYNESSHL"))
                                            {
                                                ...
                                                else if (shaderline.isComment("GAUX4FORMAT", "RGBA32F"))
                                                {
                                                    gbuffersFormat[7] = 34836;
                                                    SMCLog.info("gaux4 format : RGB32AF");
                                                }
                                                else if (shaderline.isComment("GAUX4FORMAT", "RGB32F"))
                                                {
                                                    gbuffersFormat[7] = 34837;
                                                    SMCLog.info("gaux4 format : RGB32F");
                                                }
                                                else if (shaderline.isComment("GAUX4FORMAT", "RGB16"))
                                                {
                                                ...
                                                {
                                                    if (ShaderParser.isComposite(filename) || ShaderParser.isFinal(filename))
                                                    {
                                                ...
                                                else if (shaderline.isComment("DRAWBUFFERS"))
                                                {
